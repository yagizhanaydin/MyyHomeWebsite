      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-white/90 text-sm font-medium mb-3">İsim</label>
              <input
                type="text"
                name="name"
              ...
              {RegisterFormik.touched.name && RegisterFormik.errors.name && (
                <p className="text-rose-200 text-xs mt-2">{RegisterFormik.errors.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              {RegisterFormik.touched.email && RegisterFormik.errors.email && (
                <p className="text-rose-200 text-xs mt-2">{RegisterFormik.errors.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              {RegisterFormik.touched.password && RegisterFormik.errors.password && (
                <p className="text-rose-200 text-xs mt-2">{RegisterFormik.errors.password}</p>
              )}
            </div>
            ...
            <div>
              ...
              {RegisterFormik.touched.passwordagain && RegisterFormik.errors.passwordagain && (
                <p className="text-rose-200 text-xs mt-2">{RegisterFormik.errors.passwordagain}</p>
              )}
            </div>
          </div>
          ...
          >
            {RegisterFormik.isSubmitting ? "Kayıt Yapılıyor..." : "Kayıt Ol"}
          </button>
          ...
          <div className="mt-6 text-center">
            <p className="text-white/70 text-sm">
              ...
              <a href="/login" className="text-white font-semibold hover:text-white/90 underline">
                Giriş Yapın
              </a>
            </p>
          </div>
